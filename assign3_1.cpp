            ...
            */
            ...
            class box
            {
                ...
                public :
                box(){              //default parameterless ctor
                }
                box(float length,float width,float height){         //parameterized ctor
            ...
            enum BoxMenu{
                EXIT,ADD_BOX,DISPLAY_BOX,CAL_VOLUME
            };
            int main(){
                box b1(10,20,30);
                ...
                while((choice=menu())!=0){
                    switch(choice){
                        case ADD_BOX : b1.acceptBox();
                            break;
                        case DISPLAY_BOX:b1.displayBox();
                            break;
                        case CAL_VOLUME: b1.displayBox();
                                         b1.calVolume();           
                            break;
                    }
                }
